...
print(test)
df = pd.read_csv('/home/jiayi/5moU/data/DL_fromTombo/all_RF_perf.csv')
motifs = df['motif']

for motif in motifs:
        model = joblib.load('/home/jiayi/5moU/Code/DL5mou/DeepRead/all_RF_model/' + motif + '.joblib')
        scaler = joblib.load('/home/jiayi/5moU/Code/DL5mou/DeepRead/all_RF_scaler/' + motif + '.joblib')
...
test.to_csv('/home/jiayi/5moU/data/DL_fromTombo/all_RF_pred.csv',index = 0)
